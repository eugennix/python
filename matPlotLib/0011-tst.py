...
plt.grid(True)
# смотри преамбулу
saveImg.save('pic_1_6_1', fmt='pdf')
saveImg.save('pic_1_6_1', fmt='png')
...
# смотри преамбулу
saveImg.save('pic_1_6_2', fmt='pdf')
saveImg.save('pic_1_6_2', fmt='png')
...
# смотри преамбулу
saveImg.save('pic_1_6_3', fmt='pdf')
saveImg.save('pic_1_6_3', fmt='png')
